...
module.exports = function (data) {
  ...
  if (typeof data.msg === 'string') {
    ...
    // overwrite short_message if msg is an object with a raw property
    if (typeof data.msg === 'object' && data.msg.raw) {
      payload.short_message = data.msg.raw.substring(0, 65);
    }
  }
